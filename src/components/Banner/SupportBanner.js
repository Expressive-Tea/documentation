                ...
                <div className="container">
                    ...
                    <section className="row justify-content-center text-section">
                        <div className="col-md-12 text-center">
                            <h2 className="f_p f_size_40 l_height60 wow fadeInUp" data-wow-delay="0.3s">A Simple, Clean, Flexible and Modulable <br/><span className="f_700">web framework</span> project</h2>
                            <p className="f_size_18 l_height30 wow fadeInUp" data-wow-delay="0.5s">Infused from <span className="f_600">ExpressJS</span> as strong and stable web framework<br/> Flavored with <span className="f_700">Typescript</span> to take advantage of the latest Javascript Features.</p>

                        </div>
                        <div className="col-md-6 align-self-center text-center">
                            <a href="/docs/" className="software_banner_btn btn_submit f_size_15 f_500">Getting Started</a>
                        </div>
