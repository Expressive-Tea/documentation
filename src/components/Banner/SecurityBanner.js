          ...
          <div className="col-lg-6 d-flex align-items-center">
            <div className="security_banner_content">
              <h2 className="wow fadeInUp" data-wow-delay="0.3s">
                Your Unified Solution For PC Security and Performance
              </h2>
              <p className="f_400 w_color l_height28 wow fadeInUp" data-wow-delay="0.4s">
                Download Free Antivirus and System Optimization Utility
              </p>
              <div
              ...
              >
                ...
                <a href="/#" className="w_btn">
                  <img src={require('../../img/home-security/windows_icon.png')} alt="" />
                  Windows 10
                </a>
                <a href="/#" className="w_btn">
                  <img src={require('../../img/home-security/apple_icon.png')} alt="" />
                  Mac OS 8.2
                </a>
              </div>
            </div>
