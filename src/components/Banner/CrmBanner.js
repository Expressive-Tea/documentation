            ...
            <div className="col-lg-6 d-flex align-items-center">
              <Reveal bottom cascade duraton={1200}>
                <div className="new_startup_content">
                  ...
                  <p className="f_400 w_color l_height28 wow fadeInRight" data-wow-delay="0.4s">
                    Cup of tea my lady a blinding shot lost the plot spend a penny, only a quid
                    bog-standard in my flat, morish chinwag sloshed. Cheeky chap old charles dropped
                    a clanger.!
                  </p>
                  <div
