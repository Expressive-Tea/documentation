  ...
  constructor: [
    {
      ...
      isOptional: true,
      type: {
        name: 'ExpressiveTeaServerProps',
        reference: '../interfaces-types/interfaces#expressiveteaserverprops'
      },
      defaults: '{ port: 3000}',
  ...
  module: [
    {
      name: 'Module',
      type: {
        name: 'ExpressiveTeaModuleProps',
        reference: '../interfaces-types/interfaces#expressiveteamoduleprops'
      },
