          ...
          <div className="col-lg-5">
            <div className="portfolio_details_info pr_50">
              ...
              <p className="f_400 f_size_15 mb-0">
                Why I say old chap that is spiffing tickety-boo amongst, brolly bugger say William
                in my flat Elizabeth tosser. Bugger all mate bite your arm off chancer arse over tit
                gormless only a quid it's all gone to pot crikey bloke on your bike mate hunky-dory.
              </p>
          ...
          <div className="col-lg-7">
            <div className="portfolio_details_gallery">
              <img
                ...
                src={require('../../img/portfolio-details/pr_details1.jpg')}
                alt=""
              />
              <img
                className="img-fluid mb_20"
                src={require('../../img/portfolio-details/pr_details2.jpg')}
                alt=""
              />
              <img
                className="img-fluid mb_20"
                src={require('../../img/portfolio-details/pr_details3.jpg')}
                alt=""
              />
              <img
                className="img-fluid mb_20"
                src={require('../../img/portfolio-details/pr_details4.jpg')}
                alt=""
              />
            </div>
          </div>
