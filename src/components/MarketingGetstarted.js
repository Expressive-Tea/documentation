      ...
      <section className="get_started_three sec_pad">
        <div className="container">
          <div className="sec_title text-center mb_70">
            <h2 className="f_p f_size_30 l_height45 f_600 t_color3">
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="row intregration_logo">
                <div className="col-6 intregration_item">
                  <a href=".#" className="intregration_icon">
                    <img src={require('../img/new/intregration_1.png')} alt="" />
                  </a>
                </div>
                <div className="col-6 intregration_item">
                  <a href=".#" className="intregration_icon">
                    <img src={require('../img/new/intregration_2.png')} alt="" />
                  </a>
                </div>
                <div className="col-6 intregration_item">
                  <a href=".#" className="intregration_icon">
                    <img src={require('../img/new/intregration_3.png')} alt="" />
                  </a>
                </div>
                <div className="col-6 intregration_item">
                  <a href=".#" className="intregration_icon">
                    <img src={require('../img/new/intregration_4.png')} alt="" />
                  </a>
                </div>
              </div>
            </div>
            <div className="col-lg-5 d-flex align-items-center">
              <div className="intregration_content">
                ...
                <p>
                  Owt to do with me cracking goal arse over tit cup of tea brolly in my flat
                  victoria sponge cup of char ruddy Harry, horse play cheeky it's your round
                  tomfoolery pear shaped spiffing bodge you mug blower cheers.!
                </p>
