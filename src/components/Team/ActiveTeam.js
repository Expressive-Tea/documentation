            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-3 col-sm-6">
                        <Teamitem teamImageUrl="https://gravatar.com/avatar/91976c5dd9d5242f5690caf19d30b5a3?s=1024&d=robohash&r=x" memberN="Diego Resendez" memberd="Lead Developer / Author" socialNetworks={socialNetworks}/>
                    </div>
                </div>
            </div>
        </section>
