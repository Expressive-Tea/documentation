          ...
          <div className="col-lg-6">
            <div className="event_about_content">
              ...
              <p className="wow fadeInUp" data-wow-delay="0.2s">
                So I said knees up Jeffrey grub me old mucker Oxford spend a penny, pukka codswallop
                fantastic lost the plot Queen's English. Daft he legged it mufty chancer porkies
                burke blatant pardon me lavatory.
              </p>
              <div className="row">
                <div className="col-6">
