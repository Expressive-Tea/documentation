            ...
            <div className="col-lg-6 p-0 chat_clients_feedback">
              <div className="clients_feedback_item flex-row-reverse">
                <div className="feedback_body">
                  <p>
                    Tidio has given our clients a quick and easy way to send over thoughts and
                    questions without delay or wait time! No second guessing – just asked and
                    answered quickly in order to make their purchasing decisions easier!
                  </p>
      ...
      <section className="chat_get_started_area">
        <div className="container">
          <div className="chat_get_started_content text-center">
            ...
            <p>
              A better experience for your customers, fewer headaches for your team. You'll be set
              up in minutes.
            </p>
