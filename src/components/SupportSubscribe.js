...
const SupportSubscribe =()=>{
    return(
        <section className="support_subscribe_area sec_pad">
            <img className="h_leaf one wow fadeInUp" data-wow-delay="0.4s" src={useBaseUrl("/img/new-home/tree-left.png")} alt=""/>
            <img className="h_leaf two wow fadeInUp" data-wow-delay="0.6s" src={useBaseUrl("/img/new-home/tree-right.png")} alt=""/>
