          ...
          <div className="col-lg-5">
            <div className="app_img">
              ...
              <img
                ...
                src={require('../../img/home7/iPhonex.png')}
                alt=""
              />
            </div>
          </div>
            ...
            <Reveal bottom cascade>
              <div className="app_featured_content">
                ...
                <p className="f_400">
                  ...
                  how's your father he nicked it arse over tit. Geeza the BBC bits and bobs do one
                  William pardon you up the kyver blower, lurgy codswallop show off show off pick.!!
                </p>
