        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="hosting_title analytices_title">
              ...
              <p>
                Nancy boy brown bread get stuffed mate a matie boy I grub cheeky horse play bobby
                argy-bargy loo, fantastic cockup pukka William bum bag the little rotter arse over
                tit cuppa.!
              </p>
            </div>
