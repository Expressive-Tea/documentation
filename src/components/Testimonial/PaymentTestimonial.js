            ...
            <div className="col-lg-7 d-flex align-items-center">
              <div className="testimonial_content">
                ...
                <p className="f_p f_size_20">
                  “This theme aute irure dolor in reprehe erit in voluptate velit esse cillum dolore
                  eu fugiat nulla pariatur. Excepteur for the life sint occaecat cupidatat non
                  proident, sunt in culpa qui officia de est laborum.”
                </p>
          ...
          <div className="payment_action_content text-center">
            <Reveal effect="fadeInUp" cascade>
              ...
              <p>
                ...
                <br /> don't have an account, they can create one quickly, for free.
              </p>
              <a href=".#" className="btn_hover agency_banner_btn pay_btn pay_btn_two">
                Sign Up for Free
              </a>
            </Reveal>
          </div>
