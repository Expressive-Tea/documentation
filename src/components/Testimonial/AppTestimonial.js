          ...
          <Slider ref={(c) => (this.slider = c)} className="app_testimonial_slider" {...settings}>
            <div className="app_testimonial_item text-center">
              <div className="author-img">
                <img src={require('../../img/home7/testimonial_author_img.png')} alt="" />
              </div>
              ...
              <p className="f_400">
                What a load of rubbish bits and bobs pear shaped owt to do with me bubble and squeak
                jolly good morish tinkety tonk old fruit, car boot my good sir buggered plastered
                cheeky David, haggle young delinquent say so I said bite your arm off easy peasy.
                Skive off it's all gone to pot buggered.
              </p>
            </div>
            <div className="app_testimonial_item text-center">
              <div className="author-img">
